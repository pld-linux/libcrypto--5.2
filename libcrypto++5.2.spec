...
Group:		Libraries
Source0:	http://www.cryptopp.com/cryptopp521.zip
...
%configure \
	CPPFLAGS="%{rpmcppflags} -fpermissive"
...
%attr(755,root,root) %{_libdir}/libcrypto++5.2.so.*.*.*
%attr(755,root,root) %ghost %{_libdir}/libcrypto++5.2.so.0
%{_datadir}/crypto*

%files devel
%defattr(644,root,root,755)
%attr(755,root,root) %{_libdir}/libcrypto++5.2.so
%{_libdir}/libcrypto++5.2.la
%{_includedir}/crypto*

%files static
%defattr(644,root,root,755)
%{_libdir}/libcrypto++5.2.a
